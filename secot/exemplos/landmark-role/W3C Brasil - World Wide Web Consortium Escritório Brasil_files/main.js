...
var enquire={config:{imgs:"/pub/Leiaute/WebModeloW3CImagens/"},init:function(){$("body").addClass("w3c_javascript");
var E=enquire;
appliedMedia=false;
jQuery(document).ready(function(F){if(F.browser.msie){F("style").attr("media","screen");
if(F.browser.version<=6){F("head").append("<link rel='stylesheet' href='/pub/Leiaute/WebModeloW3CCSS/IE6.css' />")
}}});
$("#w3c_nav div.w3c_sec_nav").append('<ul class="secondary_nav"><li class="label">Visões: </li><li><a href="#" class="desktop" title="Todos os recursos - estilo desktop">desktop</a></li><li><a href="#" class="mobile" title="Visão de coluna simples - estilo mobile">mobile</a></li><li><a href="#" class="print" title="Visão ampliada - sem menu - estilo para impressão">imprimir</a></li></ul>');
...
}if(!$("img",$(this)).length){if($(this).parents("div.expand_block, li.expand_block").hasClass("closed")){$(this).prepend("<img src='/pub/Leiaute/WebModeloW3CImagens/ico-plus.gif' width='9' height='9' alt='Expandir' />")
}else{$(this).prepend("<img src='/pub/Leiaute/WebModeloW3CImagens/ico-minus.gif' width='9' height='9' alt='Fechar'/>")
}$(this).wrapInner("<a href='#'></a>")
}if(!$(this).data("expand_configured")){$(this).click(function(E){E.preventDefault();
A.toggle($(this));
if($(this).parents("div.expand_block, li.expand_block").hasClass("closed")){$("img",$(this)).attr({src:"/pub/Leiaute/WebModeloW3CImagens/ico-plus.gif",alt:"Expandir"})
}else{$("img",$(this)).attr({src:"/pub/Leiaute/WebModeloW3CImagens/ico-minus.gif",alt:"Fechar"})
}})
...
if(!$("#w3c_toggle_include_show").length){$("#w3c_toggle_include").after("<form class='tMargin lMargin w3c_toggle_form' action=''><div class='noprint'><fieldset><input type='radio' id='w3c_toggle_include_show' name='w3c_toggle_include_radio'"+((A)?" checked='checked'":"")+"/> <label for='w3c_toggle_include_show'>Mostrar detalhes</label> <input type='radio' id='w3c_toggle_include_hide' name='w3c_toggle_include_radio'"+((!A)?" checked='checked'":"")+"/> <label for='w3c_toggle_include_hide'>Esconder detalhes</label></fieldset></div></form>")
...
$(".expand_section img").attr({src:"/pub/Leiaute/WebModeloW3CImagens/ico-plus.gif",alt:"Expandir"});
...
$(".expand_section img").attr({src:"/pub/Leiaute/WebModeloW3CImagens/ico-minus.gif",alt:"Fechar"});
